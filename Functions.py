...
#TYPES OF FUNCTIONS:
        ...
        #Built-in Functions:
        #           Predefined functions like len(), type(), input().
        #User-defined Functions:
        #           Custom functions defined using the def keyword.
        #Anonymous (Lambda) Functions:
        #           Single-line functions created using the lambda keyword.
...
# DECORATOR:
            #A decorator is a design pattern that allows you to modify or enhance the behavior of a function or method without changing its source code.
            # It is a higher-order function that takes another function as an argument and returns a new function.

#ADVANTAGES:

            #Code Reusability:
            #            Allows adding functionality to multiple functions without code duplication.
            #Separation of Concerns:
            #            Keeps core logic clean by separating additional functionality.
            #Readability:
            #           Enhances code readability with a clean and concise syntax.

#DISADVANTAGES:
            #Debugging Complexity:
            #           Makes debugging harder as it changes function behavior dynamically.
            #Readability Issues:
            #           Can reduce readability if overused or not well-documented.
            #Performance Overhead:
            #           May introduce slight overhead due to the wrapping.
